  ...
  <div v-show="playlist.length>0" class="player">
    ...
    > <!--        配置几个钩子,方便实现更复杂的动画效果,这些钩子就是模拟组件加载的几个过程            -->
      <div v-show="fullScreen" class="normal-player"><!-- 全屏播放器 -->
        <div class="background">
          ...
          <img alt="" width="100%" height="100%" :src="songData.songPic">
        </div>
        <div class="top">
          <div class="back" @click="back"><!-- 返回按钮  绑定一个事件, 点击是缩小为迷你播放器-->
            <i class="icon-back"></i>
          </div>
          ...
          <div ref="middleL" class="middle-l">
            <div ref="cdWrapper" class="cd-wrapper"> <!-- 歌曲唱片设计 -->
              <div class="cd" :class="cdClass">
                <img alt="" class="image" :src="songData.songPic">
              </div>
            </div>
    ...
    <transition name="mini">
      <div v-show="!fullScreen" class="mini-player" @click="open"><!-- 迷你播放器 -->
        <div class="icon">
          <img alt="" width="40" height="40" :src="songData.songPic" :class="cdClass">
          <!-- 小型唱片 也添加一个cdClass-->
        </div>
        <div class="text">
