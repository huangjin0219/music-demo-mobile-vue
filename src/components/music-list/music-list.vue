<template>
  <div class="music-list">
    ...
    <Scroll ref="list" :data="songList" class="list" :probe-type="probeType" :listen-scroll="listenScroll" @scroll="scroll">
      <!--  scroll事件就会冒泡上来 我们再监听一个scroll事件  传入自定义的数据, 激活scroll组件的功能-->
      <div>
        <!-- 传入数据, 使得scroll组件知道内容的量    设置该组件的top值-->
        <div class="song-list-wrapper">
          <songlist :songs="songList" :singername="title" @select="selectItem"></songlist>
        </div>
      </div>
